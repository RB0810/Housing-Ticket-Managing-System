...
//Scenario 1:
Given(
  "Staff is on Landlord Login Page and Landlord Portal Login Page loads",
  async function () {
    ...
    await driver.wait(
      until.urlIs("http://localhost:3000/landlordlogin"),
      10000
    );
  }
);
...
When(
  "Staff types in valid login credentials and Staff presses the Login button",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    await driver
      .findElement(By.id("landlord-login-email-textfield"))
      .sendKeys("teststaff@gmail.com");
    await driver
      .findElement(By.id("landlord-login-password-textfield"))
      .sendKeys("teststaff123");
...
Then("Staff Landing Page renders", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/landingpage/999"),
    10000
  );
});
...
When(
  "Staff clicks on the Profile button on Staff Landing Page",
  async function () {
    // Write code here that turns the phrase above into concrete actions
...
Then("Staff Profile Page is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/profile/999"),
    10000
  );
});
...
When(
  "Staff types in a new password and re-enters the same password into the text box and Staff clicks the reset password button",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    await driver.sleep(1000);
    await driver
      .findElement(By.id("staff-portal-new-password-textfield"))
      .sendKeys("teststaff123");
    await driver
      .findElement(By.id("staff-portal-confirm-password-textfield"))
      .sendKeys("teststaff123");
    await driver
      .findElement(By.id("staff-portal-reset-password-button"))
      .click();
  }
);
...
Then("A password reset alert pop-up is shown", async function () {
  // Write code here that turns the phrase above into concrete actions
  const sweetAlert = await driver.wait(
    until.elementLocated(By.className("staff-profile-password-changed-swal")),
    10000
  );
...
Then("Active tickets Page is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/tickets/999/active"),
    10000
  );
});
...
Then("Active Ticket is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/ticket/999/696968"),
    10000
  );
});
...
Then("Pending tickets Page is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/tickets/999/pending"),
    10000
  );
});
...
Then("Pending Ticket is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/ticket/999/696969"),
    10000
  );
});
...
Then("Closed tickets Page is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/tickets/999/closed"),
    10000
  );
});
...
Then("Closed Ticket is rendered", async function () {
  // Write code here that turns the phrase above into concrete actions
  await driver.wait(
    until.urlIs("http://localhost:3000/staffportal/ticket/999/696967"),
    10000
  );
});
...
Given(
  "Staff is on the view ticket page and Ticket status is Quotation Accepted",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    await driver.get("http://localhost:3000/staffportal/ticket/999/696966");
    await driver.wait(
      until.urlIs("http://localhost:3000/staffportal/ticket/999/696966"),
      10000
    );
    await driver.sleep(1000);
  }
...
Then(
  "Ticket status changes to Works Started and Ticket with Works Started status is rendered",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    const sweetAlert = await driver.wait(
      until.elementLocated(By.className("view-ticket-works-started-swal")),
      10000
    );
    const okButton = await sweetAlert.findElement(By.css(".swal2-confirm"));
    await okButton.click();
    ...
    await assert.equal(
      await driver
        .findElement(By.id("basic-ticket-details-status-textfield"))
        .getAttribute("value"),
      "Works Started"
    );
  }
...
Given(
  "Staff is on the view ticket page and Ticket status is Works Started",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    await driver.get("http://localhost:3000/staffportal/ticket/999/696966");
    await driver.wait(
...
Then(
  "Ticket status changes to Works Ended and Ticket with Works Ended status is rendered",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    const sweetAlert = await driver.wait(
      until.elementLocated(By.className("view-ticket-works-ended-swal")),
      10000
    );
    const okButton = await sweetAlert.findElement(By.css(".swal2-confirm"));
    await okButton.click();
...
Given(
  "Staff is on the view ticket page and Ticket status is Ticket Assigned",
  async function () {
    // Write code here that turns the phrase above into concrete actions
...
When(
  "Staff sets quotation required to yes and Staff clicks on upload button and chooses a file to upload and Staff clicks submit button",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    ...
    await driver.sleep(1000);
    let fileInput = await driver.findElement(
      By.id("staff-portal-upload-quotation-input")
    ); // Provide the local path of the file to be uploaded.
    const filePath = path.resolve(__dirname, "testfile.pdf");
    await fileInput.sendKeys(filePath);
    const sweetAlert = await driver.wait(
      until.elementLocated(By.className("view-ticket-update-quotation-swal")),
      10000
    );
    const okButton = await sweetAlert.findElement(By.css(".swal2-confirm"));
    await okButton.click();
    await driver.sleep(1000);
    await driver
      .findElement(By.id("staff-portal-submit-quotation-button"))
      .click();
  }
);

Then(
  "Ticket status is changed to Quotation Uploaded and Quotation is rendered in View Ticket Page and Ticket with Quotation Uploaded status is rendered",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    const sweetAlert = await driver.wait(
      until.elementLocated(By.className("view-ticket-update-quotation-swal")),
...
//Scenario 13:
Given(
  "Staff is on the view ticket page and Ticket status is Works Rejected",
  async function () {
    // Write code here that turns the phrase above into concrete actions
    await driver.get("http://localhost:3000/staffportal/ticket/999/696965");
    await driver.wait(
      until.urlIs("http://localhost:3000/staffportal/ticket/999/696965"),
      10000
    );
    await driver.sleep(1000);
  }
