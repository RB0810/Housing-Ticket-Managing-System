Feature: Staff Portal
    ...
    Scenario: View Active Ticket
        Given Staff clicks on "View Ticket" button
        Then Ticket is rendered
    ...
    Scenario: Restart Works
        ...
        Then Ticket status changes to "Restart Works" and Ticket with "Restart Works" status is rendered